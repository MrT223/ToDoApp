...
const CuteBot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: "model",
      text: "Konnichiwa Master! 📝 Hôm nay Master cần làm gì không? Miku check giúp cho nha! 🎵",
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          role: "model",
          text: "Miku không kết nối được với Database rồi... 😿",
        },
      ]);
    } finally {
      setIsThinking(false);
            ...
            <div className="flex items-center gap-2">
              <div className="bg-white/20 p-1 rounded-full">
                <img
                  ...
                  onError={(e) =>
                    (e.target.src =
                      "https://api.dicebear.com/9.x/fun-emoji/svg?seed=Miku")
                  }
                  alt="Miku"
